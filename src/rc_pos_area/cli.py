...
def setup_argparse() -> argparse.ArgumentParser:
    ...
    # Global options
    parser.add_argument(
        "--verbose", action="store_true", help="Detailed progress output"
    )
    ...
    batch_parser.add_argument(
        "input_dir", type=str, help="Input directory containing Excel files"
    )
    batch_parser.add_argument(
        "--output-dir",
        type=str,
    ...
    batch_parser.add_argument(
        "--dry-run", action="store_true", help="Validate only, do not process"
    )

    # Mode 3: Report generation
    report_parser = subparsers.add_parser("report", help="Generate summary report")
    report_parser.add_argument(
        "processed_dir", type=str, help="Directory containing processed Excel files"
    )
    report_parser.add_argument(
        "--output",
        type=str,
